...
class PracticeSearchPageWidget extends StatefulWidget {
  const PracticeSearchPageWidget({Key? key}) : super(key: key);
                  ...
                  children: [
                                    ...
                                    fieldViewBuilder: (
                                      ...
                                      return TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: 'Search Chapters here...',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium,
                                          hintStyle:
                    ...
                    if (!FFAppState().searchActive)
                      Builder(
                        builder: (context) {
                          final searchResults =
                              FFAppState().allSubTopics.toList();
                            ...
                            itemBuilder: (context, searchResultsIndex) {
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  setState(() {
                                    FFAppState().numberOfTabs = FFAppState()
                                        .numberOfTabs
                                        .toList()
                                        .cast<int>();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, searchResultsIndex) {
                              ...
                              return InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.numTab = await actions.getTabs(
                                    101,
                                  );
                                  setState(() {
                                    FFAppState().numberOfTabs = FFAppState()
